      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="fixed inset-y-0 right-0 max-w-full flex pl-4 sm:pl-10">
            ...
            >
              {/* Header */}
              <div className="p-4 sm:p-5 bg-brand-header text-white flex items-center justify-between">
              ...
              {/* Footer / Summary */}
              {cart?.items?.length > 0 && (
                <div className="p-4 sm:p-5 border-t border-slate-100 bg-slate-50 flex flex-col gap-3 sm:gap-4">
